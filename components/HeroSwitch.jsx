...
export default function HeroSwitch({ active }) {
  ...
  return (
    <Link
      ...
      className="group absolute right-0 top-1/2 z-20 flex -translate-y-[0%] items-center gap-2 rounded-l-full border border-r-0 border-white/15 bg-white/[0.07] py-2.5 pl-3 pr-2.5 backdrop-blur transition-all duration-300 hover:gap-3 hover:bg-brand-yellow sm:gap-2.5 sm:py-3 sm:pl-5 sm:pr-4 md:hidden"
    >
